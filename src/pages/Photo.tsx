import SwiperComponents from "@/partials/Swiper";
...
export const Photo = () => {
  ...
  return (
    <div className="">
      <div className="bg-[#E8D3B7]">
        <div className="max-w-sm mx-4 sm:max-w-7xl sm:mx-auto">
          <h2 className="text-xl font-bold tracking-tight text-gray-900 sm:text-4xl py-8">
            {t("gallery.title")}
          </h2>
          <p className="text-base mb-8">{t("gallery.desc")}</p>
          <div className="pb-16">
            <SwiperComponents />
          </div>
        </div>
      ...
      <div>
        <div className="bg-[#713F12]">
          <h2 className="text-xl font-bold tracking-tight text-gray-100 sm:text-4xl py-10 max-w-sm sm:max-w-7xl mx-4 sm:mx-auto">
            {t("collection.title")}
          </h2>
          <div className="max-w-sm sm:max-w-7xl mx-4 sm:mx-auto mt-8 text-center">
            <Lightbox
              index={index}
              slides={slides}
              plugins={[Inline]}
          ...
          <div className="max-w-sm mx-auto space-y-2 text-center py-8 text-gray-100">
            <p className="text-lg font-semibold">
              {t(`gallery.${texts[index]}.title`)}
            </p>
